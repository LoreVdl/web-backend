...
<html>
  ...
  <body>
    <h1>Bieren Order by</h1>
    <p><?= $messageContainer ?></p>
    <table>
      <thead>
        <tr>
          <th>Biernummer </a></th>
          <th><a href="index.php?order_by=naam-asc">Bier</a></th>
          <th><a href="index.php?order_by=brnaam-asc">Brouwer</a></th>
          <th><a href="index.php?order_by=soort-asc">Soort</a></th>
          <th><a href="index.php?order_by=alcohol-asc">Alcoholpercentage</a></th>
        </tr>
      </thead>
      <tbody>
