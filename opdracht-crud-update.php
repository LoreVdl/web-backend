...
try
{
  ...
  if(isset($_POST['wijzigen']))
  {
    ...
    if($wijzigenSucces)
    {
      $message = "Gelukt, brouwer nr " . $_SESSION['editnr'] . " met succes gewijzigd";
    }
    else
    {
      $message = "Aanpassing is niet gelukt. Probeer opnieuw";
    }
  }
}
        ...
        <tbody>
          <?php foreach($brouwers as $brouwer): ?>
            <tr>
              ...
              <?php endforeach ?>
              <td>
                <button type="submit" name="delete" value="<?= $brouwer['brouwernr'] ?>"></button>
              </td>
              <td>
                <button type="submit" name="edit" value="<?= $brouwer['brouwernr'] ?>"></button>
              </td>
            </tr>
          <?php endforeach; ?>
        </tbody>
